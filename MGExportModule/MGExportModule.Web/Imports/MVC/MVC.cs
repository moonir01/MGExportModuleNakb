...
namespace MVC
{
    public static class Views
    {
        ...
        {
            public static class CmnItemBrand
            {
                public const string CmnItemBrandIndex = "~/Modules/Common/CmnItemBrand/CmnItemBrandIndex.cshtml";
            }

            public static class CmnItemCategory
            {
                public const string CmnItemCategoryIndex = "~/Modules/Common/CmnItemCategory/CmnItemCategoryIndex.cshtml";
            }

            public static class CmnItemGroup
            {
                public const string CmnItemGroupIndex = "~/Modules/Common/CmnItemGroup/CmnItemGroupIndex.cshtml";
            }

            public static class CmnItemMaster
            {
                public const string CmnItemMasterIndex = "~/Modules/Common/CmnItemMaster/CmnItemMasterIndex.cshtml";
            }

            public static class CmnItemModel
            {
                public const string CmnItemModelIndex = "~/Modules/Common/CmnItemModel/CmnItemModelIndex.cshtml";
            }

            public static class CmnItemSize
            {
                public const string CmnItemSizeIndex = "~/Modules/Common/CmnItemSize/CmnItemSizeIndex.cshtml";
            }
