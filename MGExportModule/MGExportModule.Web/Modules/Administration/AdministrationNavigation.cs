...
using Administration = MGExportModule.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: MGExportModule.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
...
[assembly: NavigationLink(int.MaxValue, "Administration/Item", typeof(MyPages.CmnItemMasterController), icon: null)]